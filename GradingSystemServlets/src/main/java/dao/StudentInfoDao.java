...
public class StudentInfoDao implements StudentDaoInterface {
    ...
    public void registerStudent(String ssn, String firstName, String mi, String lastName, java.sql.Date birthDate, String street, String phone, String zipcode, String deptId, String password) throws ClassNotFoundException, SQLException {
        Class.forName("com.mysql.jdbc.Driver");
